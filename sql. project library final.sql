...
FROM tbl_book_loans bl JOIN tbl_book b ON bl.book_loans_BookID = b.book_BookID
...
SELECT lb.library_branch_BranchName,
COUNT(bl.book_loans_BookID) AS total_books_loaned
FROM tbl_library_branch lb LEFT JOIN tbl_book_loans bl 
...
SELECT b.borrower_BorrowerName,b.borrower_BorrowerAddress,
COUNT(bl.book_loans_BookID) AS number_of_books_checked_out
FROM tbl_borrower b JOIN tbl_book_loans bl 
